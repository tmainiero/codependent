...
%% TEST-SBL-CONTAINS: \codep@sbl@version{1}
%% TEST-SBL-CONTAINS: \codep@sbl@atom
%% TEST-SBL-CONTAINS: \codep@sbl@cmddef{Hom}{kind}{newcommand}
%% TEST-SBL-CONTAINS: \codep@sbl@cmddef{Hom}{arity}{2}
%% TEST-SBL-CONTAINS: \codep@sbl@cmddef{caty}{kind}{newcommand}
%% TEST-SBL-CONTAINS: \codep@sbl@cmddef{caty}{arity}{1}
%% TEST-SBL-CONTAINS: \codep@sbl@cmddef{Tr}{kind}{newcommand}
%% TEST-SBL-CONTAINS: \codep@sbl@cmddef{Tr}{arity}{0}
%% TEST-SBL-CONTAINS: \codep@sbl@use
%% TEST-SBL-CONTAINS: \codep@sbl@def
%% TEST-SBL-CONTAINS: \codep@sbl@label
%% TEST-SBL-CONTAINS: \codep@sbl@tag
%% TEST-SBL-COUNT: \codep@sbl@atom{1.2}{theorem} = 1
...
%% ---------- codependent ----------
\usepackage[depth=2]{codependent}
