...
%% TEST-CDP-CONTAINS: \codep@sbl@version{1}
%% TEST-CDP-CONTAINS: \codep@sbl@atom
%% TEST-CDP-CONTAINS: \codep@sbl@cmddef{Hom}{kind}{newcommand}
%% TEST-CDP-CONTAINS: \codep@sbl@cmddef{Hom}{arity}{2}
%% TEST-CDP-CONTAINS: \codep@sbl@cmddef{caty}{kind}{newcommand}
%% TEST-CDP-CONTAINS: \codep@sbl@cmddef{caty}{arity}{1}
%% TEST-CDP-CONTAINS: \codep@sbl@cmddef{Tr}{kind}{newcommand}
%% TEST-CDP-CONTAINS: \codep@sbl@cmddef{Tr}{arity}{0}
%% TEST-CDP-CONTAINS: \codep@sbl@use
%% TEST-CDP-CONTAINS: \codep@sbl@def
%% TEST-CDP-CONTAINS: \codep@sbl@label
%% TEST-CDP-CONTAINS: \codep@sbl@tag
%% TEST-CDP-COUNT: \codep@sbl@atom{1.2}{theorem} = 1
