...
\codepsetup{appendix/pagenum-format={##1~\textemdash~p.~##2}}
...
\begin{proof}[\codepproofof{prop:square}]
...
%% ====================================================================
%%  Section 7: W04 proof-anchor features (codep-proof:N.M namespace)
%% ====================================================================
...
%% AND emits a codep-proof:N.M named PDF destination at the proof body.
%% Backref entries for this proof atom resolve to codep-proof:N.M,
%% not to the parent theorem heading.  (W04-P01, Bug #1 closed.)
\begin{proof}[\codepproofof*{thm:long}]
...
%% ====================================================================
%%  Dependency Index (appendix mode — W04-P04)
%%  Emits bidirectional links: theorem body \to appendix entry AND
%%  appendix entry \to theorem heading.  Page numbers use the
