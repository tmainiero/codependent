...
%% TEST-PURPOSE: Stripped integration fixture modelled on a real category-theory
%% TEST-KIND: unit
...
%%              docs/DESIGN.md §8a.0–§9a (integration surface);
