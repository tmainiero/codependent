%% TEST-NAME: stress-ta-inline
%% TEST-PURPOSE: Inline TA stress fixture using default backref color.
%% TEST-KIND: stress
...
%% TEST-PDF-PAGES: 4
%% TEST-PDF-STEXT: Stress fixture inline default
...
\title{Stress fixture inline default}
\author{Test}
\date{}
...
\begin{definition}\label{def:orphan-inline-nested}
Outer definition for nested-close teardown stress.
\begin{example}\label{ex:orphan-inline-nested}
Inner example.
\end{example}
\end{definition}

\begin{theorem}\label{thm:orphan-inline-after}
After both teardown scenarios.
References \cref{lem:orphan-inline-list} and \cref{def:orphan-inline-nested}.
\end{theorem}
