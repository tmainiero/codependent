...
%% TEST-KIND: stress
%% TEST-BEHAVIOR: B-NUM-SHARED, B-REND-INLINE, B-LINK-CLICKABLE, B-LINK-NO-ORPHAN, B-USEDIN-READING-ORDER, B-PRINTKIND-DISPLAY-NAME
%% TEST-STATUS: LIVE
...
\codeptrack{theorem,proposition,lemma,corollary,definition,notation,terminology,example,remark,question,printkindstress}
